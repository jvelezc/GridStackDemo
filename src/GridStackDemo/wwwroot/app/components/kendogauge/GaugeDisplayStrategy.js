"use strict";
var GaugeDisplayStrategy = (function () {
    function GaugeDisplayStrategy() {
    }
    GaugeDisplayStrategy.prototype.Display = function (widget, widgetInstance) {
        ...
        if (widget) {
            ...
            var height = widget.height * 120;
            var width = widget.width * 65;
