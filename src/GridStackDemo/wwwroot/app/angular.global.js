...
(function (names) {
    ...
    ModulesExternal.ANGULAR_WIZARD = "mgo-angular-wizard";
    ...
    Components.fnolWizard = "fnolWizard";
    Components.fnolAsignSubmit = "fnolAsignSubmit";
    Components.fnolInformation = "fnolInformation";
    Components.fnolPolicySearch = "fnolPolicySearch";
    Components.fnolServices = "fnolServices";
    Components.fnolClaimDetails = "fnolClaimDetails";
